...
// TestNewPod
#define COCOAPODS_POD_AVAILABLE_TestNewPod
#define COCOAPODS_VERSION_MAJOR_TestNewPod 0
#define COCOAPODS_VERSION_MINOR_TestNewPod 1
#define COCOAPODS_VERSION_PATCH_TestNewPod 0
